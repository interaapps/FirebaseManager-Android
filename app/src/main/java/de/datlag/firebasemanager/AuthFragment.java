...
import de.datlag.firebasemanager.auth.OAuth;
import de.datlag.firebasemanager.auth.OAuthEnum;
import de.datlag.firebasemanager.core.FirebaseManager;
import de.datlag.firebasemanager.auth.GoogleAuth;
...
public class AuthFragment extends Fragment {
    ...
    private void initLogic() {
        ...
        oAuth.startLogin(new OAuth.LoginCallbacks() {
            @Override
